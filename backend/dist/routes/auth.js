...
const schemas_1 = require("../../../shared/src/validation/schemas");
const schemas_2 = require("../../../shared/src/validation/schemas");
...
router.post('/login', (0, auth_2.authRateLimit)(5, 15), async (req, res, next) => {
    try {
        ...
        if (error instanceof Error && 'code' in error) {
            ...
            const statusCode = errors_1.ErrorHttpStatusMap[appError.code] || 500;
            return res.status(statusCode).json((0, errors_1.formatErrorResponse)(appError));
        }
        next(error);
    }
});
